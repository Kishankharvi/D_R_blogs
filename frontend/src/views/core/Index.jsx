...
function Index() {
  ...
  const fetchPosts = async () => {
    try {
      ...
      const response_category = await apiInstance.get(`post/category/lists/`);
      setPosts(response_post.data);
      console.log(response_category.data);
                      ...
                      >
                        <li>
                          ...
                          >
                            ...
                            {post?.profile?.full_name || "Kishan Kharvi"}
                          </a>
                        </li>
                        <li className="mt-2">
                    ...
                    <div className="mt-2">
                      <div className="card bg-transparent">
                        ...
                        <div className="d-flex flex-column align-items-center mt-3 pb-2">
                          ...
                          <small>{cat.post_count} Articles</small>
                        </div>
                      </div>
                    </div>
                  );
